...
[Placas oficiales de Arduino](https://store.arduino.cc/collections/boards-modules). Recomendación en este rubro: [Arduino Nano ESP 32](https://store.arduino.cc/collections/boards-modules). 
...
- Cons: Menos integración, menos disponibilidad.
...
Para casos específicos podemos elegir algún otro tipo de placa. 

## Tiendas 

Algunas cosas se pueden encontrar en tiendas físicas, otras se podrán conseguir en línea. Podemos buscar placas, componentes y sensores para revisar disponibilidad. 
...
- [330Ohms](https://www.330ohms.com/)
- Amazon, Ali Express, etc. 

Importante considerar tiempos de envío y disponibilidades. 
